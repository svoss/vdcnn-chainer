...
def define_args():
    ...
    parser.add_argument('--depth', type=int, default=config.get('model', 'depth'), help="Depth of the network in terms of conv. layers either 9, 17, 29 or 49")
    ...
    parser.add_argument('--test', type=int, default=config.get('training','test'), help="Will limit training and test set to 1000 examples")
    parser.add_argument('--fixed_size', type=int, default=config.get('model', 'fixed_size'), help="Fixed size to pad sentenced to")
    parser.add_argument('--dataset', type=str, default=config.get('training', 'dataset'), help="The dataset to train on. Choose from ag-news, ")
